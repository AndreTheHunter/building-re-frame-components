  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :compiler {:main building-re-frame-components.core
                           ...
                           :output-to "resources/public/js/compiled/building_re_frame_components.js"
               ...
               {:id "min"
                :source-paths ["src"]
                :compiler {:output-to "resources/public/js/compiled/building_re_frame_components.js"
                           :main building-re-frame-components.core
